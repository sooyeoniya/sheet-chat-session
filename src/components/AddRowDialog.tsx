...
export function AddRowDialog({ open, onOpenChange, dailySheetId }: AddRowDialogProps) {
  const { register, handleSubmit, reset, setValue, watch, formState: { errors } } = useForm<AddRowForm>({
    defaultValues: {
      isPublic: true,
      type: 'text'
    }
      ...
      <DialogContent>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={(value) => setValue('type', value as AddRowForm['type'])}>
              <SelectTrigger>
