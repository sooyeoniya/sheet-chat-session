...
export function CreateDailySheetDialog({ open, onOpenChange, classSpaceId }: CreateDailySheetDialogProps) {
  const { register, handleSubmit, reset, formState: { errors } } = useForm<CreateDailySheetForm>();
